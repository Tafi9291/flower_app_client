...
class _TOrderListItemsState extends State<TOrderListItems> {
  ...
  void getData() async {
    try {
      final List<Order> response = await dataService.getOrderData(); // Use the getData method from the DataService
      setState(() {
        _orders = response;
      });
    } catch (e) {
              ...
              children: [
                ...
                IconButton(
                  onPressed: () => Get.to(() => OrderDetailScreen(
                    ...
                    usersId: filteredOrders[index].usersId!,
                  )), 
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('2 ngày sau khi đặt', style: Theme.of(context).textTheme.titleMedium),
                          ],
                        ),
                      ),
                    ],
